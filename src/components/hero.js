...
export default function Hero(props) {
  return (
    <div className="relative">
      ...
      <div className={`relative z-30 container flex flex-col justify-between items-start ${props.isBig === 'true' ? 'py-[100px]' : 'py-[50px]'}`}>
        {props.label && (
        ...
        <h1 className={`max-w-[58%] font-semibold font-display  !leading-tight text-white ${props.isBig === 'true' ? 'mt-4 text-[40px] lg:text-7xl xl:text-7xl' : 'mt-0 lg:text-5xl xl:text-5xl text-[32px]'}`}>
          {props.title}
        </h1>
