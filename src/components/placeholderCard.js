export default function placeholderCard() {
  return (
    <div className="flex-[30%] flex flex-col rounded-xl overflow-hidden p-4 transition-all duration-200 ease-in-out relative h-[257px] bg-white shadow-[0_0_10px_rgba(0,0,0,0.1)]">
