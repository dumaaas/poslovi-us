...
import { shortDescFormater } from "@/helpers/functions";
...
export default function blogCard(props) {
  return (
    ...
    >
      <div className="flex justify-between items-start gap-[10px] flex-wrap w-full">
        <div className="flex gap-[15px] items-start w-full lg:flex-row flex-col">
          <div
            style={{ backgroundImage: `url(${props.blog.url})` }}
            className="lg:min-h-[220px] h-full min-h-[200px] lg:w-[250px] w-full min-w-full   lg:min-w-[250px] bg-center bg-no-repeat bg-cover"
          ></div>

          <div className="flex flex-col gap-[10px] items-start p-4 lg:min-h-[220px] h-full min-h-[200px] justify-between">
            ...
            <p className="text-[#6b7280] leading-[20px] text-[14px]">
              {shortDescFormater(props.blog.short_desc, 400)}
            </p>
